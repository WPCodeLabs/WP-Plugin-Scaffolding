...
namespace Wpcl\WpPluginScaffolding\Classes\Widgets;
...
class Sample extends \WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_id_base = 'wpcl_sample_widget';
		$this->widget_name    = 'Sample Widget';
		$this->widget_options = array(
			'classname'   => 'wpcl_sample_widget_class',
	...
	public function form( $instance ) {
		...
		include \Wpcl\WpPluginScaffolding\Plugin::path( 'includes/classes/widgets/forms/sample.php' );
	}
