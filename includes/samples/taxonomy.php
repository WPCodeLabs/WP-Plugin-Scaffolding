...
class Taxonomy extends \Wpcl\Scaffolding\Plugin {
	...
	public static function get_tax_args() {
		$labels = array(
			'name'                       => _x( 'Sample Taxonomies', 'Taxonomy General Name', self::$name ),
			'singular_name'              => _x( 'Sample Taxonomy', 'Taxonomy Singular Name', self::$name ),
			'menu_name'                  => __( 'Sample Taxonomy', self::$name ),
